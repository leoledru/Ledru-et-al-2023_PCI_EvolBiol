...
number_of_animals = 11; %77
number_of_plants  = 11;  %77
...
sigmaC = sigmaK-1;
C = @(trait_plant_y,trait_plant_yi) exp(sigmaC^2*Beta^2/2).*exp(-(trait_plant_y-trait_plant_yi + sigmaC^2*Beta^2).^2./(2*sigmaC^2));0
...
%
Df = 1e-3; % Diffusion coefficient %AF
%         Df = 0;  % Tondeuse
