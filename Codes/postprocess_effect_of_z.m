...
scatter(foraging_trait,final_biomass_p,50,'s','filled','MarkerFaceColor',Color(5,:))
...
yyaxis right
ylabel({'Functional diversity of'; 'resources $FDis_r$'},'interpreter','latex','FontSize',20)
scatter(foraging_trait,FDis_plant_mean,50,'s','filled','MarkerFaceColor',Color(5,:)) %[.2 .8 .2]
