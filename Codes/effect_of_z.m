%% GÉNÈRE 11 COMMUS, CHACUNE AYANT UN TRAIT DE FORAGING UNIQUE ET SANS ÉVOLUTION DU FORAGING
%% PERMET DE TESTER L'EFFET DE L'AF EN DÉTAILS EN TESTANT CHAQUE VALEUR POSSIBLE
%% (MAIS SANS DIVERSITÉ POUR LE TRAIT DE FORAGING)
...
D = 0; % No diffusion over foraging trait
